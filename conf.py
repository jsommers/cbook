...
# globaltoc.html not included below
html_sidebars = {
  '**': ['localtoc.html', 'relations.html', 'searchbox.html', 'bugs.html'],
}
...
man_pages = [
    ('index', 'cintro', 'cintro Documentation',
     ['Joel Sommers'], 1)
]
...
texinfo_documents = [
  ('index', 'cintro', 'cintro Documentation',
   'Joel Sommers', 'cintro', 'One line description of project.',
   'Miscellaneous'),
]
